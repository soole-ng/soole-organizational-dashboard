...
declare class SymbolStyleLayer extends StyleLayer {
	...
	getValueAndResolveTokens<T extends keyof LayoutProps$1>(name: T, feature: Feature, canonical: CanonicalTileID, availableImages: ImageId[]): string;
	getAppearanceValueAndResolveTokens<T extends keyof AppearanceProps>(appearance: SymbolAppearance, name: T, feature: Feature, canonical: CanonicalTileID, availableImages: ImageId[]): string | LayoutProps$1[T];
...
declare class MapWorker {
	...
	projections: Record<string, Projection$1>;
...
declare class Actor {
	...
	receive(message: MessageEvent<Task$2>): void;
	processTask(id: string, task: Task$2): void;
	remove(): void;
}
type LayoutProps$2 = {
	"visibility": DataConstantProperty<"visible" | "none">;
