        ...
        <div className="px-4 pb-4 pt-3 space-y-2 bg-white">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <DriverAvatar photoUrl={trip.driverPhotoUrl} name={trip.driverName} size="sm" />
              <div className="min-w-0">
                <div className="flex items-center gap-1">
                  <p className="text-[11px] font-semibold text-primary-500 truncate">{trip.driverName}</p>
                  {trip.driverRating != null && (
                    <span className="flex items-center gap-0.5 text-[10px] font-bold text-neutral-300 flex-shrink-0">
